...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    'en': {
        ...
        '🌙 ダークモード':      '🌙 Dark Mode',
        # Manual Widget
        '共有マニュアル (Wiki)': 'Shared Manual (Wiki)',
        'マニュアル検索...':    'Search manuals...',
        '＋ 新規マニュアル作成': '+ New Manual',
        '◀ 戻る':               '◀ Back',
        '✏️ 編集':              '✏️ Edit',
        '🗑️ 削除':              '🗑️ Delete',
        '🔗 リンクコピー':       '🔗 Copy Link',
        'タイトルを入力...':    'Enter title...',
        '本文をMarkdown形式で入力...': 'Enter body in Markdown format...',
        '💬 コメント':          '💬 Comments',
        'コメントを入力...':    'Enter a comment...',
        '送信':                 'Send',
        '📷 画像挿入':          '📷 Insert Image',
        '画像の簡単な編集 (赤ペン)': 'Simple Image Edit (Red Pen)',
        '画像の読み込みに失敗しました。': 'Failed to load image.',
        '項目の内容 (見出し)...': 'Section Title...',
        '📷 画像を選択':         '📷 Select Image',
        '画像なし':             'No image',
        '＋ 項目追加':           '+ Add Section',
        ...
        '🔤 テキスト':           '🔤 Text',
        'テキスト入力':          'Enter Text',
        '挿入するテキストを入力してください:': 'Enter text to insert:',
        '未分類':               'Uncategorized',
        'カテゴリ (任意)...':    'Category (Optional)...',
        '画像プレビュー':       'Image Preview',
        'カテゴリ管理':           'Category Manager',
        '名前変更':             'Rename',
        '新しいカテゴリ名:':       'New Category Name:',
        'カテゴリ「{0}」を削除し、含まれるマニュアルを「未分類」にしますか？': 'Delete category "{0}" and move its manuals to "Uncategorized"?',
        '新規':                 'New',
        '新しいカテゴリ名を入力:': 'Enter new category name:',
        'マニュアルの添付画像を削除しました: {0}': 'Deleted attached image: {0}',
        'PDF エクスポート':      'Export PDF',
        'PDF 保存':             'Save PDF',
        'PDFファイルとして保存しました。': 'Saved as PDF file.',
        '元に戻す':             'Undo',
        'タグ (カンマ区切り)...': 'Tags (comma separated)...',
        'データベースが混雑しています。しばらくしてから再試行してください。': 'Database is busy. Please try again later.',
        '移動':                 'Move',
        '切り抜き':             'Crop',
        '適用':                 'Apply',
        '色':                   'Color',
        'Ctrl+マウスホイールで拡大・縮小できます': 'Ctrl+Mouse Wheel to zoom',
        # Tray / dialogs
        '開く (Open)':          'Open',
        '完全に終了 (Quit)':    'Quit',
        ...
        '設定を保存':                               'Save Settings',
        '初期化':                                   'Reset',
        'この段落へのリンクをコピー': 'Copy link to this paragraph',
        'アンカーリンクをコピーしました。': 'Anchor link copied to clipboard.',
        '🔄 初期化':                                '🔄 Reset',
        '保存しました':                             'Saved',
        '✅ 保存しました':                           '✅ Saved',
        '変更がありません':                          'No changes',
    ...
    'ko': {
        ...
        '🔗 リンクコピー':       '🔗 링크 복사',
        'タイトルを入力...':    '제목을 입력하세요...',
        '本文をMarkdown形式で入力...': '본문을 Markdown 형식으로 입력하세요...',
        '💬 コメント':          '💬 코멘트',
        'コメントを入力...':    '코멘트를 입력하세요...',
        '送信':                 '전송',
        '📷 画像挿入':          '📷 이미지 삽입',
        '画像の簡単な編集 (赤ペン)': '간단한 이미지 편집 (빨간펜)',
        '画像の読み込みに失敗しました。': '이미지를 불러오는데 실패했습니다.',
        '項目の内容 (見出し)...': '항목 내용 (제목)...',
        '📷 画像を選択':         '📷 이미지 선택',
        '画像なし':             '이미지 없음',
        '＋ 項目追加':           '+ 항목 추가',
        ...
        '🔤 テキスト':           '🔤 텍스트',
        'テキスト入力':          '텍스트 입력',
        '挿入するテキストを入力してください:': '삽입할 텍스트를 입력하세요:',
        '未分類':               '미분류',
        'カテゴリ (任意)...':    '카테고리 (선택)...',
        '画像プレビュー':       '이미지 미리보기',
        'カテゴリ管理':           '카테고리 관리',
        '名前変更':             '이름 변경',
        '新しいカテゴリ名:':       '새 카테고리 이름:',
        'カテゴリ「{0}」を削除し、含まれるマニュアルを「未分類」にしますか？': '카테고리 "{0}"을(를) 삭제하고 포함된 매뉴얼을 "미분류"로 변경할까요?',
        '新規':                 '신규',
        '新しいカテゴリ名を入力:': '새 카테고리 이름 입력:',
        'マニュアルの添付画像を削除しました: {0}': '매뉴얼 첨부 이미지를 삭제했습니다: {0}',
        'PDF エクスポート':      'PDF 내보내기',
        'PDF 保存':             'PDF 저장',
        'PDFファイルとして保存しました。': 'PDF 파일로 저장되었습니다.',
        '元に戻す':             '실행 취소',
        'タグ (カンマ区切り)...': '태그 (쉼표 구분)...',
        'データベースが混雑しています。しばらくしてから再試行してください。': '데이터베이스가 혼잡합니다. 잠시 후 다시 시도해 주세요.',
        '移動':                 '이동',
        '切り抜き':             '자르기',
        '適用':                 '적용',
        '色':                   '색상',
        'Ctrl+マウスホイールで拡大・縮小できます': 'Ctrl+마우스 휠로 확대/축소할 수 있습니다',
        # Tray / dialogs
        '開く (Open)':          '열기',
        '完全に終了 (Quit)':    '종료',
        ...
        '設定を保存':                               '설정 저장',
        '初期化':                                   '초기화',
        'この段落へのリンクをコピー': '이 문단 링크 복사',
        'アンカーリンクをコピーしました。': '앵커 링크를 클립보드에 복사했습니다.',
        '🔄 初期化':                                '🔄 초기화',
        '保存しました':                             '저장됨',
        '✅ 保存しました':                           '✅ 저장됨',
        '変更がありません':                          '변경 없음',
    ...
    'zh': {
        ...
        '🔗 リンクコピー':       '🔗 复制链接',
        'タイトルを入力...':    '请输入标题...',
        '本文をMarkdown形式で入力...': '请以Markdown格式输入正文...',
        '💬 コメント':          '💬 评论',
        'コメントを入力...':    '请输入评论...',
        '送信':                 '发送',
        '📷 画像挿入':          '📷 插入图片',
        '画像の簡単な編集 (赤ペン)': '简单的图片编辑（红笔）',
        '画像の読み込みに失敗しました。': '加载图片失败。',
        '項目の内容 (見出し)...': '项目内容（标题）...',
        '📷 画像を選択':         '📷 选择图片',
        '画像なし':             '无图片',
        '＋ 項目追加':           '+ 添加项目',
        ...
        '名前変更':             '重命名',
        '新しいカテゴリ名:':       '新分类名称：',
        'カテゴリ「{0}」を削除し、含まれるマニュアルを「未分類」にしますか？': '删除分类"{0}"并将包含的手册移至"未分类"？',
        '新規':                 '新建',
        '新しいカテゴリ名を入力:': '请输入新分类名称：',
        'マニュアルの添付画像を削除しました: {0}': '已删除手册附加图片：{0}',
        'PDF エクスポート':      '导出 PDF',
        'PDF 保存':             '保存 PDF',
        'PDFファイルとして保存しました。': '已保存为 PDF 文件。',
        '元に戻す':             '撤销',
        'タグ (カンマ区切り)...': '标签（逗号分隔）...',
        'データベースが混雑しています。しばらくしてから再試行してください。': '数据库繁忙。请稍后重试。',
        '移動':                 '移动',
        '切り抜き':             '裁剪',
        '適用':                 '应用',
        '色':                   '颜色',
        'Ctrl+マウスホイールで拡大・縮小できます': '按住 Ctrl+鼠标滚轮 可以缩放',
        # Tray / dialogs
        '開く (Open)':          '打开',
        '完全に終了 (Quit)':    '退出',
        'LEE電力モニター':      'LEE 电力监控',
        ...
        '設定を保存':                               '保存设置',
        '初期化':                                   '重置',
        'この段落へのリンクをコピー': '复制此段落链接',
        'アンカーリンクをコピーしました。': '锚点链接已复制到剪贴板。',
        '🔄 初期化':                                '🔄 重置',
        '保存しました':                             '已保存',
        '✅ 保存しました':                           '✅ 已保存',
        '変更がありません':                          '无更改',
